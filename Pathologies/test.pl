...
resource('inconnue', image, image('conseils/inconnue.jpg')).
...
interface_principal :- new(@main,dialog('Pathologies: Consultation medicale')),
                       new(@quitter, button('QUITTER', and(message(@main,destroy), message(@main,free)))),
...
creer_interface :- new(@interface,dialog('Pathologies: Consultation medicale')),
